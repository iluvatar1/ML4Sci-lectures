c = get_config()
c.CourseDirectory.course_id = "Intro Machine Learning for Science"
#c.IncludeHeaderFooter.header = "./header.ipynb"
c.CourseDirectory.source_directory = '.'
c.CourseDirectory.release_directory = 'release'
c.CourseDirectory.ignore = ['.ipynb_checkpoints', '*.pyc', '__pycache__', 'drafts', 'release']
...
# server set up.
#c.ExecutePreprocessor.timeout = 5
#c.ExecutePreprocessor.startup_timeout = 5
#c.ExecutePreprocessor.timeout_func = 10
###############################################################################
